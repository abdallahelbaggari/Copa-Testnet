/* =================================================================
   COPA.pi TESTNET · functions/cancel-payment.js
   Route: /cancel-payment
   Re-approves stuck payments — SANDBOX · sandbox:true
================================================================= */

export async function onRequestGet(context) {
  return new Response(JSON.stringify({
    success:'true', route:'/cancel-payment', network:'TESTNET·sandbox:true'
